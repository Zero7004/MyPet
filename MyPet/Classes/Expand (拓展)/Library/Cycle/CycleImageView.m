...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        self.canAutoSliding = YES;
        self.canInfiniteSliding = YES;
...
- (CycleImageViewPageControl *)pageControl
{
    if (!_pageControl) {
        ...
        _pageControl.currentPageIndicatorTintColor = RGB(0, 161, 233);
