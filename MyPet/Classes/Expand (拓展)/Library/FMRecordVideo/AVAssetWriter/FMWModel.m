...
- (void)setUpPreviewLayerWithType:(FMVideoViewType )type
{
    ...
    switch (type) {
        case Type1X1:
            rect = CGRectMake(39, 0, (Screen_Width - (39*2)), (Screen_Width - (39*2)));
            break;
        case Type4X3:
            rect = CGRectMake(39, 0, (Screen_Width - (39*2)), (Screen_Width - (39*2)) * 4/3);
            break;
        case TypeFullScreen:
...
- (void)setRECORD_MAX_TIME:(NSInteger)RECORD_MAX_TIME {
    _RECORD_MAX_TIME = RECORD_MAX_TIME;
    self.writeManager.RECORD_MAX_TIME = self.RECORD_MAX_TIME;
}
